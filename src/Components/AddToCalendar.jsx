  ...
  return (
    <div className={`flex flex-wrap items-center justify-center gap-3 ${className}`}>
      <a
        ...
        className="inline-flex items-center gap-2 text-[11px] font-semibold tracking-[0.22em] uppercase px-5 py-3 bg-[#2D4C3B] text-[#FFFFFF] hover:bg-[#3a6050] transition-colors duration-200"
      >
      ...
      <button
        onClick={downloadIcs}
        type="button"
        className="inline-flex items-center gap-2 text-[11px] font-semibold tracking-[0.22em] uppercase px-5 py-3 border border-[#2D4C3B]/40 text-[#2D4C3B] hover:bg-[#2D4C3B] hover:text-[#FFFFFF] transition-colors duration-200"
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
