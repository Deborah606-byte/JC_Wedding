              ...
              <Reveal x={-40} y={0} className="w-full lg:w-[42%] flex-shrink-0">
                <div className="relative overflow-hidden shadow-xl group">
                  ...
                  <div className="absolute top-5 left-5">
                    <p className="font-display italic text-[#FFFFFF]/85 text-sm drop-shadow">I</p>
                    <p className="text-[10px] tracking-[0.3em] uppercase text-[#FFFFFF] font-semibold drop-shadow mt-1">Locations</p>
                  </div>
                </div>
              </Reveal>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-14">
              <Reveal x={-40} y={0} className="w-full lg:w-[42%] flex-shrink-0">
                <div className="relative overflow-hidden shadow-xl group">
                  ...
                  <div className="absolute inset-0 bg-[#2D4C3B]/25" />
                  <div className="absolute top-5 left-5">
                    <p className="font-display italic text-[#FFFFFF]/85 text-sm drop-shadow">III</p>
                    <p className="text-[10px] tracking-[0.3em] uppercase text-[#FFFFFF] font-semibold drop-shadow mt-1">Programme</p>
                  </div>
                </div>
              </Reveal>
      ...
      <section className="bg-white py-16 lg:py-24 border-t border-stone-100">
        <div className="max-w-5xl mx-auto px-6 lg:px-10">
          ...
          <StaggerGroup stagger={0.12} className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-5 items-stretch">
            ...
            {/* Opay */}
            <StaggerItem className="bg-[#2D4C3B] text-[#FFFFFF] p-7 lg:p-8 flex flex-col gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-[#FFFFFF]">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12" y2="18"/>
                  </svg>
                </div>
                <h3 className="font-display italic text-[#FFFFFF] text-xl">Opay</h3>
              </div>
              <div className="flex flex-col gap-2 text-[13.5px]">
                <div>
                  <p className="text-[10px] tracking-[0.22em] uppercase text-[#FFFFFF]/55 font-semibold">Phone Number</p>
                  <p className="text-[#FFFFFF]/85 mt-0.5 font-mono tracking-wider">+234 [TBD]</p>
                </div>
                <div>
                  <p className="text-[10px] tracking-[0.22em] uppercase text-[#FFFFFF]/55 font-semibold">Account Name</p>
                  <p className="text-[#FFFFFF]/85 mt-0.5">[Account holder &mdash; TBD]</p>
                </div>
              </div>
            </StaggerItem>
          ...
          <StaggerGroup stagger={0.12} className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-5 items-stretch">
            ...
            <StaggerItem className="bg-[#2D4C3B] text-[#FFFFFF] p-7 lg:p-8 flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-display italic text-[#FFFFFF] text-xl">Where to Stay</h3>
              </div>
              <div className="flex flex-col gap-2 text-[13.5px] flex-1">
                <p className="text-[#FFFFFF]/75 leading-[1.75]">
                  A few suggested options near the venue:
                </p>
                <ul className="text-[#FFFFFF]/85 leading-[1.85] space-y-1">
